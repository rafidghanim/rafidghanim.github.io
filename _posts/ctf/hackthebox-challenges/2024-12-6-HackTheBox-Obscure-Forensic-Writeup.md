...
- **Solution Steps**:
Given [Obscure.zip](/files/Obscure.zip) as attachment challenges, then after i extract it it given
```sh
...
![[Pasted image 20251206194543.png]]
...
![[Pasted image 20251206200321.png]]
we have 4 http requests that we can check it one by one.
![[Pasted image 20251206200423.png]]
the first payload 
```sh
...
![[Pasted image 20251206200646.png]]
the second payload
```sh
...
![[Pasted image 20251206200721.png]]
the third payload
```sh
...
![[Pasted image 20251206200756.png]]
the fourth
```sh
...
![[Pasted image 20251206202931.png]]
the lasts
```sh
