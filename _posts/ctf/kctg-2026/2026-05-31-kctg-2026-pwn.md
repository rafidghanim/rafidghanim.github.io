...
layout: post
title: "Ret2Win"
description: "Writeup challenge pwn ret2win dengan kerentanan stack buffer overflow."
date: 2025-05-31 00:00:01 +0700
author: rafidghanim
categories: [writeup, ctf]
tags: [ctf, pwn, bof, ret2win, pwndbg, ropgadget]
toc: true
comments: true
mermaid: true
...
| Challenge | Solve Chall Inii Plis |
| Category | Pwn |
| Difficulty | Beginner |
...
Hal ini biasanya terjadi karena masalah **stack alignment** pada arsitektur x86-64.
Pada beberapa kondisi, fungsi tertentu membutuhkan stack agar tetap berada pada alignment 16-byte. Jika alignment tidak sesuai, program dapat crash ketika menjalankan instruksi tertentu di dalam fungsi.
