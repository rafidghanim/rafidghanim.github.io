---
layout: post
title: "UIUCTF 2025 - Multi-Category Writeup"
description: "UIUCTF 2025 writeup covering pwn, crypto, reversing, and OSINT-style challenges."
date: 2025-07-29
categories: [writeup, ctf]
tags: [pwn, crypto, reversing, osint]
image: /assets/img/uiuctf-2025/logo.png
author: rafidghanim
toc: true
---

<p align="left"> <img src="/assets/img/uiuctf-2025/logo.png" alt="logo" width="300"></p>
...
- **Attachments**: [Handout.tar.gz](/assets/files/uiuctf-2025/handout.tar.gz)
- **Solution Steps**:
...
### 🔹 flag_checker
- **Description**:
- **Attachments**: [flag_checker](/assets/files/uiuctf-2025/flag_checker)
- **Solution Steps**:
...
<p align="left"><img src="/assets/img/uiuctf-2025/park.jpg" alt="Park" width="250"  height="550"></p>
- **Flag**: 
