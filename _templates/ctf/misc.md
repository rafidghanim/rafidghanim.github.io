...
List visible oddities, hints, constraints, and suspicious data.

## Hidden Pattern

Describe repeated structures, encodings, ordering, or non-obvious relationships.

## Decoding / Parsing

Explain transformations, parsing logic, or manual decoding steps.

## Automation

Describe scripts or tools used to automate the solution.
