...
List names, handles, images, locations, dates, metadata, and other clues.

## Search Strategy

Document search queries, pivots, reverse image search, map checks, and archive lookups.

## Evidence

Record screenshots, links, timestamps, and source context.

## Verification

Explain how the final answer was confirmed and why alternatives were rejected.
