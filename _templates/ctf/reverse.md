...
Record file type, strings, imports, sections, symbols, and obvious constants.

## Dynamic Analysis

Describe runtime behavior, breakpoints, traces, and debugger observations.

## Decompilation Notes

Summarize important functions, state machines, checks, or transformations.

## Patch / Keygen / Solver

Explain whether you patched execution, generated a valid input, or scripted the algorithm.
