...
Document routes, technologies, cookies, headers, and visible behavior.

## Endpoint Analysis

Map important endpoints, parameters, methods, and authorization boundaries.

## Vulnerability

Explain the vulnerable behavior and why it is exploitable.

## Payload

Record the final payload and any variants tested.

## Exploitation

Show how the payload is delivered and how the flag is obtained.
